...
pub enum SyntaxKind {
    ...
    INDEX_EXPR = 63u16,
    FUNCTION_CALL = 64u16,
    RANGE_EXPRESSION_FROM_TO = 65u16,
    RANGE_EXPRESSION_FROM_TO_STEP = 66u16,
    FOR_CLAUSE = 67u16,
    IF_CLAUSE = 68u16,
    ASSIGNMENTS_OPT = 69u16,
    ASSIGNMENTS = 70u16,
    PARAMETERS = 71u16,
    ARGUMENTS = 72u16,
    CHILDREN = 73u16,
    BRACED_CHILDREN = 74u16,
}
impl SyntaxKind {
    #[doc = r" All the possible [`SyntaxKind`] variants."]
    pub const VARIANTS: [SyntaxKind; 75usize] = [
        SyntaxKind::AND,
        SyntaxKind::BANG,
        SyntaxKind::CARET,
        SyntaxKind::COLON,
    ...
    pub fn from_code(n: u16) -> Option<Self> {
        match n {
            ...
            48u16 => Some(SyntaxKind::ASSIGNMENT_STATEMENT),
            ...
            52u16 => Some(SyntaxKind::ASSIGNMENT),
            ...
            60u16 => Some(SyntaxKind::BIN_EXPR),
            61u16 => Some(SyntaxKind::VECTOR_EXPR),
            62u16 => Some(SyntaxKind::LOOKUP_EXPR),
            63u16 => Some(SyntaxKind::INDEX_EXPR),
            64u16 => Some(SyntaxKind::FUNCTION_CALL),
            65u16 => Some(SyntaxKind::RANGE_EXPRESSION_FROM_TO),
            66u16 => Some(SyntaxKind::RANGE_EXPRESSION_FROM_TO_STEP),
            67u16 => Some(SyntaxKind::FOR_CLAUSE),
            68u16 => Some(SyntaxKind::IF_CLAUSE),
            69u16 => Some(SyntaxKind::ASSIGNMENTS_OPT),
            70u16 => Some(SyntaxKind::ASSIGNMENTS),
            71u16 => Some(SyntaxKind::PARAMETERS),
            72u16 => Some(SyntaxKind::ARGUMENTS),
            73u16 => Some(SyntaxKind::CHILDREN),
            74u16 => Some(SyntaxKind::BRACED_CHILDREN),
            _ => None,
        }
    }
}
