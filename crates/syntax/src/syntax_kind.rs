...
pub enum SyntaxKind {
    ...
    FOR_STATEMENT = 56u16,
    ASSIGNMENTS = 57u16,
    BRACED_ACTIONS = 58u16,
    ASSIGNMENT = 59u16,
    LIST_EXPR = 60u16,
    UNARY_EXPR = 61u16,
    TERNARY_EXPR = 62u16,
    PAREN_EXPR = 63u16,
    LIST_COMPREHENSION_EXPR = 64u16,
    BIN_EXPR = 65u16,
    LOOKUP_EXPR = 66u16,
    INDEX_EXPR = 67u16,
    FUNCTION_CALL = 68u16,
    FOR_CLAUSE = 69u16,
    RANGE_EXPR_FROM_TO = 70u16,
    RANGE_EXPR_FROM_TO_STEP = 71u16,
    LET_CLAUSE = 72u16,
    IF_CLAUSE = 73u16,
    ASSIGNMENTS_OPT = 74u16,
    PARAMETERS = 75u16,
    ARGUMENTS = 76u16,
    CHILDREN = 77u16,
...
impl SyntaxKind {
    ...
    pub fn from_code(n: u16) -> Option<Self> {
        match n {
            ...
            56u16 => Some(SyntaxKind::FOR_STATEMENT),
            57u16 => Some(SyntaxKind::ASSIGNMENTS),
            58u16 => Some(SyntaxKind::BRACED_ACTIONS),
            59u16 => Some(SyntaxKind::ASSIGNMENT),
            60u16 => Some(SyntaxKind::LIST_EXPR),
            61u16 => Some(SyntaxKind::UNARY_EXPR),
            62u16 => Some(SyntaxKind::TERNARY_EXPR),
            63u16 => Some(SyntaxKind::PAREN_EXPR),
            64u16 => Some(SyntaxKind::LIST_COMPREHENSION_EXPR),
            65u16 => Some(SyntaxKind::BIN_EXPR),
            66u16 => Some(SyntaxKind::LOOKUP_EXPR),
            67u16 => Some(SyntaxKind::INDEX_EXPR),
            68u16 => Some(SyntaxKind::FUNCTION_CALL),
            69u16 => Some(SyntaxKind::FOR_CLAUSE),
            70u16 => Some(SyntaxKind::RANGE_EXPR_FROM_TO),
            71u16 => Some(SyntaxKind::RANGE_EXPR_FROM_TO_STEP),
            72u16 => Some(SyntaxKind::LET_CLAUSE),
            73u16 => Some(SyntaxKind::IF_CLAUSE),
            74u16 => Some(SyntaxKind::ASSIGNMENTS_OPT),
