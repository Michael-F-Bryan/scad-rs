...
pub enum SyntaxKind {
    ...
    INCLUDE = 48u16,
    USE = 49u16,
    ASSIGNMENT_STATEMENT = 50u16,
    NAMED_FUNCTION_DEFINITION = 51u16,
    NAMED_MODULE_DEFINITION = 52u16,
    MODULE_INSTANTIATION = 53u16,
    IF_STATEMENT = 54u16,
    BRACED_ACTIONS = 55u16,
    ASSIGNMENT = 56u16,
    EXPRESSIONS = 57u16,
    LIST_EXPR = 58u16,
    UNARY_EXPR = 59u16,
    TERNARY_EXPR = 60u16,
    PAREN_EXPR = 61u16,
    LIST_COMPREHENSION_EXPR = 62u16,
    BIN_EXPR = 63u16,
    LOOKUP_EXPR = 64u16,
    INDEX_EXPR = 65u16,
    FUNCTION_CALL = 66u16,
    FOR_CLAUSE = 67u16,
    RANGE_EXPRESSION_FROM_TO = 68u16,
    RANGE_EXPRESSION_FROM_TO_STEP = 69u16,
    LET_CLAUSE = 70u16,
    IF_CLAUSE = 71u16,
    ASSIGNMENTS_OPT = 72u16,
    ASSIGNMENTS = 73u16,
    PARAMETERS = 74u16,
    ARGUMENTS = 75u16,
    CHILDREN = 76u16,
    BRACED_CHILDREN = 77u16,
}
impl SyntaxKind {
    #[doc = r" All the possible [`SyntaxKind`] variants."]
    pub const VARIANTS: [SyntaxKind; 78usize] = [
        SyntaxKind::AND,
        SyntaxKind::BANG,
        SyntaxKind::CARET,
        SyntaxKind::COLON,
    ...
    pub fn from_code(n: u16) -> Option<Self> {
        match n {
            ...
            32u16 => Some(SyntaxKind::OR),
            33u16 => Some(SyntaxKind::PERCENT),
            34u16 => Some(SyntaxKind::PLUS),
            35u16 => Some(SyntaxKind::QUESTION_MARK),
            36u16 => Some(SyntaxKind::R_BRACKET),
            37u16 => Some(SyntaxKind::R_CURLY),
            38u16 => Some(SyntaxKind::R_PAREN),
            39u16 => Some(SyntaxKind::SEMICOLON),
            40u16 => Some(SyntaxKind::SLASH),
            41u16 => Some(SyntaxKind::STAR),
            42u16 => Some(SyntaxKind::STRING),
            43u16 => Some(SyntaxKind::TRUE_KW),
            44u16 => Some(SyntaxKind::UNDEF_KW),
            45u16 => Some(SyntaxKind::USE_KW),
            46u16 => Some(SyntaxKind::WHITESPACE),
            47u16 => Some(SyntaxKind::PACKAGE),
            48u16 => Some(SyntaxKind::INCLUDE),
            49u16 => Some(SyntaxKind::USE),
            50u16 => Some(SyntaxKind::ASSIGNMENT_STATEMENT),
            51u16 => Some(SyntaxKind::NAMED_FUNCTION_DEFINITION),
            52u16 => Some(SyntaxKind::NAMED_MODULE_DEFINITION),
            53u16 => Some(SyntaxKind::MODULE_INSTANTIATION),
            54u16 => Some(SyntaxKind::IF_STATEMENT),
            55u16 => Some(SyntaxKind::BRACED_ACTIONS),
            56u16 => Some(SyntaxKind::ASSIGNMENT),
            57u16 => Some(SyntaxKind::EXPRESSIONS),
            58u16 => Some(SyntaxKind::LIST_EXPR),
            59u16 => Some(SyntaxKind::UNARY_EXPR),
            60u16 => Some(SyntaxKind::TERNARY_EXPR),
            61u16 => Some(SyntaxKind::PAREN_EXPR),
            62u16 => Some(SyntaxKind::LIST_COMPREHENSION_EXPR),
            ...
            67u16 => Some(SyntaxKind::FOR_CLAUSE),
            68u16 => Some(SyntaxKind::RANGE_EXPRESSION_FROM_TO),
            69u16 => Some(SyntaxKind::RANGE_EXPRESSION_FROM_TO_STEP),
            70u16 => Some(SyntaxKind::LET_CLAUSE),
            71u16 => Some(SyntaxKind::IF_CLAUSE),
            72u16 => Some(SyntaxKind::ASSIGNMENTS_OPT),
            73u16 => Some(SyntaxKind::ASSIGNMENTS),
            74u16 => Some(SyntaxKind::PARAMETERS),
            75u16 => Some(SyntaxKind::ARGUMENTS),
            76u16 => Some(SyntaxKind::CHILDREN),
            77u16 => Some(SyntaxKind::BRACED_CHILDREN),
            _ => None,
        }
    }
}
