...
pub enum SyntaxKind {
    ...
    EXPRESSIONS = 54u16,
    INDEX_EXPR = 55u16,
    LIST_EXPRESSION = 56u16,
    UNARY_EXPR = 57u16,
    TERNARY_EXPR = 58u16,
    PAREN_EXPR = 59u16,
    LIST_COMPREHENSION_EXPR = 60u16,
    LET_CLAUSE = 61u16,
    FUNCTION_CALL = 62u16,
    BIN_EXPR = 63u16,
    RANGE_EXPRESSION_FROM_TO = 64u16,
    RANGE_EXPRESSION_FROM_TO_STEP = 65u16,
    FOR_CLAUSE = 66u16,
    IF_CLAUSE = 67u16,
    ASSIGNMENTS_OPT = 68u16,
    ASSIGNMENTS = 69u16,
    PARAMETERS = 70u16,
    ARGUMENTS = 71u16,
    CHILDREN = 72u16,
    BRACED_CHILDREN = 73u16,
}
impl SyntaxKind {
    #[doc = r" All the possible [`SyntaxKind`] variants."]
    pub const VARIANTS: [SyntaxKind; 74usize] = [
        SyntaxKind::AND,
        SyntaxKind::BANG,
        SyntaxKind::CARET,
        SyntaxKind::COLON,
    ...
    pub fn from_code(n: u16) -> Option<Self> {
        match n {
            ...
            53u16 => Some(SyntaxKind::ASSIGNMENT),
            54u16 => Some(SyntaxKind::EXPRESSIONS),
            55u16 => Some(SyntaxKind::INDEX_EXPR),
            56u16 => Some(SyntaxKind::LIST_EXPRESSION),
            57u16 => Some(SyntaxKind::UNARY_EXPR),
            58u16 => Some(SyntaxKind::TERNARY_EXPR),
            59u16 => Some(SyntaxKind::PAREN_EXPR),
            60u16 => Some(SyntaxKind::LIST_COMPREHENSION_EXPR),
            61u16 => Some(SyntaxKind::LET_CLAUSE),
            62u16 => Some(SyntaxKind::FUNCTION_CALL),
            63u16 => Some(SyntaxKind::BIN_EXPR),
            64u16 => Some(SyntaxKind::RANGE_EXPRESSION_FROM_TO),
            65u16 => Some(SyntaxKind::RANGE_EXPRESSION_FROM_TO_STEP),
            66u16 => Some(SyntaxKind::FOR_CLAUSE),
            67u16 => Some(SyntaxKind::IF_CLAUSE),
            68u16 => Some(SyntaxKind::ASSIGNMENTS_OPT),
            69u16 => Some(SyntaxKind::ASSIGNMENTS),
            70u16 => Some(SyntaxKind::PARAMETERS),
            71u16 => Some(SyntaxKind::ARGUMENTS),
            72u16 => Some(SyntaxKind::CHILDREN),
            73u16 => Some(SyntaxKind::BRACED_CHILDREN),
            _ => None,
        }
    }
}
